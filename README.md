...
| RegAD (공식 체크포인트) | STN 정합 + Mahalanobis | shot4 0.918 / shot8 0.924 | 0.965 / **0.968** |
| 본 연구 (제안서-충실 FiLM 파이프라인) | 결함SSL + 정규화 FiLM | 1s 0.830 / 5s 0.918 | 0.851 / 0.871 |

*WinCLIP zero-shot = 0.914 img / 0.780 px. RegAD는 공식 체크포인트가 shot 2/4/8만 제공하므로 K=5와 가장 근접한 shot 4·8을 비교점으로 사용.*
